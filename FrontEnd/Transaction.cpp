...
bool Transaction::transfer(){
  ...
  if(validateAccountNumber()){
    ...
    if(validateAccountNumber()){
      ...
      if(stof(transferamount) > stof(accountHolderBalance)){cout << "invalid input\n"; accountNumberTo =""; accountHolderNameTo ="";return false;}
      if(stof(transferamount) + stof(accountHolderBalanceTo) > 9999999){cout << "invalid input\n"; accountNumberTo =""; accountHolderNameTo ="";return false;}
      if(stof(transferamount) > 100000 && sessiontype == "standard"){cout << "invalid input\n"; accountNumberTo =""; accountHolderNameTo ="";return false;}

      transferStandardSessionLimit += stof(transferamount);
  ...
  if(validateAccountNumber()){
    if(validatePlan()){
      ...
      if(planType == "NP"){
        ...
        appendTosessionTransactionFile += "08 "+tempname+" "+accountNumber+" 00000.00 NP\n";
        accountHolderName = "";
        return true;
      }
      else if(planType == "SP"){
        cout << "account updated to student\n";
        appendTosessionTransactionFile += "08 "+tempname+" "+accountNumber+" 00000.00 SP\n";
        accountHolderName = "";
        return true;
      }
    }
...
bool Transaction::deposit(){
  ...
  if(validateAccountNumber()){
    ...
    if(stof(depositAmount) > 100000){cout << "invalid input\n"; return false;}
    if(stof(depositAmount) + stof(accountHolderBalance) > 99999){cout << "invalid input\n"; return false;}
...
bool Transaction::paybill(){
  ...
  if(validateAccountNumber()){
    if(validatePayee()){
      ...
      if(stof(paymentAmount) > stof(accountHolderBalance)){cout << "invalid input\n";return false;};
      if(stof(paymentAmount) > 2000 && sessiontype == "standard"){cout << "invalid input\n";return false;};
...
bool Transaction::withdrawal(){
  ...
  if(validateAccountNumber()){
    ...
    if(stof(withdrawalamount) > 50000 && sessiontype == "standard"){cout << "invalid input\n"; return false;}
    if(stof(withdrawalamount) > stof(accountHolderBalance)){cout << "invalid input\n";return false;}
    withdrawalStandardSessionLimit += stof(withdrawalamount);
    if( withdrawalStandardSessionLimit > 50000 && sessiontype == "standard") {cout << "invalid input\n";  withdrawalStandardSessionLimit -= stof(withdrawalamount); return false;}
...
bool Transaction::logout(){
  ...
  appendTosessionTransactionFile += string("00 ")+tempname+string(" 00000 ")+string("00000.00   ");
  ...
  if(validateAccountNumber()){
    ...
    if(cancelCheck(d)){return false;};
      if(d == "d"){
        ...
        appendTosessionTransactionFile += string("07 ")+tempname+" "+string(accountNumber)+" "+string("00000.00")+string(" ");
...
bool Transaction::create(){
  ...
  appendTosessionTransactionFile += string("05 ")+string(temp_name)+" "+string(accountNumber)+string(" ")+string(balance)+"   "+string("\n");
...
bool Transaction::Delete(){
  ...
  if(validateAccountNumber()){
    ...
    appendTosessionTransactionFile += "06 "+tempname+" "+accountNumber+" "+string("00000.00")+string(" \n");
